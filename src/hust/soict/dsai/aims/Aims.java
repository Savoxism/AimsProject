...
public class Aims {
	...
	public static void main(String[] args) throws LimitExceededException {
	    // Adding 10 example media to the store
	    store.addMedia(new Book("Effective Java", "Programming", 45.99f));
	    store.addMedia(new Book("Clean Code", "Programming", 39.99f));
	    store.addMedia(new Book("Design Patterns", "Software Engineering", 49.99f));

	    store.addMedia(new DigitalVideoDisc("The Lion King", "Animation", 19.99f, 90, "Roger Allers"));
	    store.addMedia(new DigitalVideoDisc("Inception", "Science Fiction", 22.99f, 148, "Christopher Nolan"));
	    store.addMedia(new DigitalVideoDisc("Avatar", "Science Fiction", 24.99f, 162, "James Cameron"));

	    CompactDisc cd1 = new CompactDisc("The Wall", "Rock", 25.99f, 0, "Pink Floyd");
	    cd1.addTrack(new Track("Another Brick in the Wall", 4));
	    cd1.addTrack(new Track("Comfortably Numb", 6));
	    store.addMedia(cd1);

	    CompactDisc cd2 = new CompactDisc("Greatest Hits", "Pop", 29.99f, 0, "Various Artists");
	    cd2.addTrack(new Track("Track A", 5));
	    cd2.addTrack(new Track("Track B", 3));
	    store.addMedia(cd2);

	    store.addMedia(new DigitalVideoDisc("The Matrix", "Science Fiction", 23.99f, 136, "The Wachowskis"));

	    store.addMedia(new Book("The Pragmatic Programmer", "Programming", 35.99f));
	...
	private static void addMediaStore(Scanner scanner, Store store) {
		...
		switch (choice) {
			...
			case 2:
				...
				scanner.nextLine();
				media = new DigitalVideoDisc(dvdTitle, dvdCategory, dvdCost, dvdLength, director);
				break;
			case 3:
				...
				CompactDisc cd = new CompactDisc(cdTitle, cdCategory, cdCost, 0, artist);
				while (true) {
