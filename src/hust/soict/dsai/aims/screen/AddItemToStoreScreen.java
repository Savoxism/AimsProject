...
public class AddItemToStoreScreen extends JFrame {
	...
	public static void main(String[] args) {
		...
		DigitalVideoDisc dvd1 = new DigitalVideoDisc("The Lion King", "Animation", 19.95f, 87, "Roger Aller");
		...
		DigitalVideoDisc dvd3 = new DigitalVideoDisc("Aladin", "Animation", 18.99f, 75, "John Musker");
		System.out.println(dvd3.getId());
		store.addMedia(dvd3);

		DigitalVideoDisc dvd4 = new DigitalVideoDisc("The Lion King", "Animation", 19.95f, 87, "Roger Aller");
		System.out.println(dvd4.getId());
		store.addMedia(dvd4);

		DigitalVideoDisc dvd5 = new DigitalVideoDisc("Star Wars", "Science Fiction", 24.95f, 87, "George Lucas");
		System.out.println(dvd5.getId());
		store.addMedia(dvd5);

		DigitalVideoDisc dvd6 = new DigitalVideoDisc("Aladin", "Animation", 18.99f, 75, "John Musker");
		System.out.println(dvd6.getId());
		store.addMedia(dvd6);

		DigitalVideoDisc dvd7 = new DigitalVideoDisc("The Lion King", "Animation", 19.95f, 87, "Roger Aller");
		System.out.println(dvd7.getId());
		store.addMedia(dvd7);

		DigitalVideoDisc dvd8 = new DigitalVideoDisc("Star Wars", "Science Fiction", 24.95f, 87, "George Lucas");
